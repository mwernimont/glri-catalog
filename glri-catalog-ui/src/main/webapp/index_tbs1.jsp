...
<html>
    <head>
		...
		<script type="text/javascript" src="js/app/main_tbs1.js"></script>
		...
		<link rel="stylesheet" type="text/css" href="style/css/app_tbs1.css" />
							...
							<div class="row">
								<div class="col-xs-6">		
									<div class="row" style="padding-bottom: 10px;">
										...
										<div class="col-xs-8">
											<select class="selectpicker pull-left" name="resource" id="resource_input" multiple title="Any" data-width="90%">
									...
									<div class="row">
										...
										<div class="col-xs-8">
											<select class="selectpicker pull-left" id="loc_type_input" name="loc_type" multiple title="Any" data-width="90%">
									...
									<div class="row">
										...
										<div class="col-xs-8">
											<select class="selectpicker pull-left" id="loc_name_input" name="loc_name" multiple title="Any" data-width="90%">
								...
								<div class="col-xs-6" style="min-width: 565px;">
									<div class="row">
										<div class="col-xs-12">
